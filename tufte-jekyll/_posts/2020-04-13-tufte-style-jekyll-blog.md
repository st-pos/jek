...
layout: post
title:  "Smart brevity"
date:   2023-08-03 09:46:04
categories: jekyll css
---

Smart brevity explains how being concise and getting to the point quickly is a valuable communication skill in the modern ==workplace== and life. The book provides tips and strategies for writing and speaking clearly and concisely to convey your message effectively without unnecessary fluff.

**THE BOTTOM LINE:** Lorem ipsum dolor sit amet, consectetur adipiscing elit.
<!--more--> 


The idea for this project is essentially cribbed wholesale from Tufte and R Markdown's Tufte Handout format{% sidenote 'One' 'See [tufte-latex.github.io/tufte-latex/](https://tufte-latex.github.io/tufte-latex/) and [rmarkdown.rstudio.com/tufte_handout_format](http://rmarkdown.rstudio.com/tufte_handout_format.html)' %} This page is an adaptation of the [Tufte Handout PDF](http://rmarkdown.rstudio.com/examples/tufte-handout.pdf).
